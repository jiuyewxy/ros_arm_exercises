...
void makeGrasps(std::vector<moveit_msgs::Grasp>& grasps){
  ...
  grasps[0].grasp_pose.pose.position.z = 0.07;
  tf2::Quaternion orientation;
  orientation.setRPY(0, M_PI/2.0, 0);
  grasps[0].grasp_pose.pose.orientation = tf2::toMsg(orientation);
  // 设置pre_grasp_approach,沿着z轴靠近抓取点,移动的最小距离为0.08m，期望距离为0.12米
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
  ...
  collision_objects[1].primitive_poses[0].position.z = 0.03;
